...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CommonWallet/CommonWallet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SoraFoundation/SoraFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SoraKeystore/SoraKeystore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SoraUI/SoraUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Starscream/Starscream.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SubstrateSdk/SubstrateSdk.framework"
