...
protocol ConnectionPoolProtocol {
    func setupConnection() throws -> ChainConnection
...
//        }
        ...
        let connection = try connectionFactory.createConnection(delegate: self)
        connections["Frequency"] = WeakWrapper(target: connection)
