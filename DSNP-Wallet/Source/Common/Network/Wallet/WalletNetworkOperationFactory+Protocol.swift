...
//        let baseOp = BaseOperation<TransferMetaData?>()
//        return CompoundOperationWrapper(targetOperation: baseOp)
//    }
//
...
//        )
//        
//        let extrinsicFactory = ExtrinsicOperationFactory(accountId: selectedAccount.accountId,
//                                                         chain: chain,
//                                                         cryptoType: <#T##MultiassetCryptoType#>,
//                                                         signaturePayloadFormat: <#T##ExtrinsicSignaturePayloadFormat#>,
//                                                         runtimeRegistry: <#T##RuntimeCodingServiceProtocol#>,
//                                                         customExtensions: <#T##[ExtrinsicExtension]#>,
//                                                         engine: <#T##JSONRPCEngine#>,
//                                                         operationManager: <#T##OperationManagerProtocol#>)
//
