...
final class RuntimeProviderFactory {
    let fileOperationFactory: RuntimeFilesOperationFactoryProtocol //Fetching and saving files representing runtime
    let repository: AnyDataProviderRepository<RuntimeMetadataItem> //Repository for storing RuntimeMetadataItem into CoreData
    let dataOperationFactory: DataOperationFactoryProtocol //Fetching API calls
